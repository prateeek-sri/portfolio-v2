...
export default function About() {
  ...
  return (
    <div className="px-10 sm:px-20 md:px-32 lg:mb-12 lg:px-60 mx-auto max-w-300">
      <main className="  max-w-screen ">
        <div className=" mx-auto pt-16 -pb-10 max-w-7xl">
          <div className=" mx-auto flex flex-col ">
            <h1
              className={`mt-6 mb-12 bg-linear-to-br to-blue-500 via-red-400/90 from-yellow-500  bg-clip-text text-transparent selection:text-gray-700 dark:selection:text-white/90 items-center mx-auto text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-semibold`}
            >
              About
            </h1>
            <div className="mx-auto transition-all duration-1000 ease-in-out -mt-8">
              <Image
                ...
                height={800}
                width={800}
                className={`select-none h-40 w-40 circGradient rounded-full shadow-md ${
                  isDark ? "shadow-purple-500/30" : "shadow-purple-500/10"
                }`}
                alt="prateek srivastav"
                priority
              />
            </div>
            <p className="mt-8 max-w-xl text-center md:w-[70%] mx-auto text-2xl md:text-2xl lg:text-2xl mb-2 px-2">
          ...
          <CategoryCard />
          <div
            className={` text-[0.92rem] text-base mx-12 font-light ${
              isDark ? "text-white" : "text-grey-900"
            }`}
          >
            <p className="mt-6 mb-12 font-normal">
              Web Developer who develops modern, reactive, and user-friendly web
              ...
              Typescript and Tailwind CSS building large-scale web applications.
              Beyond code and design, anime is my creative fuel — from
              breathtaking worlds to unforgettable characters, it’s where I find
              emotion, and energy. A few of my favorites characters are:{" "}
              <span className="inline-flex items-baseline">
                <Image
                  src={Flash}
                  alt="flash"
            ...
            <p className="">
              ...
              <a
                onClick={() =>
                  navigator.clipboard.writeText(
                    "prateekkumarsrivastav99@gmail.com"
                  )
                }
                ...
                href="mailto:prateekkumarsrivastav99@gmail.com"
              >
                {" "}
                prateekkumarsrivastav99@gmail.com
              </a>{" "}
              ...
              <a
                href="http://linkedin.com/in/prateek-kumar-srivastav"
              ...
              <a
                href="https://instagram.com/_.prateeek_"
                target="blank"
                rel="noopener noreferrer"
          ...
          <div className="flex mx-auto justify-center mt-16 select-none">
            ...
            <Image
              src={isDark ? love_white : love_black}
              alt="love"
              width="30"
              className="-mt-4"
            />
